  ...
  <div class="post-wrap mb-4">
    ...
    <div class="post-main p-3">
      ...
      <div class="continue-read mt-3">
        <a href="<?php the_permalink(); ?>"><span><?php esc_html_e('Read More','plumber-services'); ?></span><span class="screen-reader-text"><?php esc_html_e( 'Read More','plumber-services' );?></span></a>
      </div>
    </div>
  </div>
</article>